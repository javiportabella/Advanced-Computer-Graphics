...
void main()
{
    ...
    //float opticalThickness = tFar - tNear;     //optical thickness
    //float transmittance = exp(-u_absortion_coef * opticalThickness);       //formula given -> Beer-Lambert
    ...
    while (t < tFar) {
        ...
        // Add the step to advance in the ray
        t += u_step_length;
    }
